...
public class Science extends Math {
	...
	//When you create an object from a class which has parents
	//Java runs the parent constructor first the runs the 
	//constructors from top bottom
	
	public static void main(String[] args) {
		
		//If the things which you can access depend on the 
		//data type of the object. For example; if you create object 
		//like ==> Teacher sci = new Science(); then you can access 
		//just the Teacher class thing. If you create the 
