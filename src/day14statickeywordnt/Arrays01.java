...
public class Arrays01 {
	...
	public static void main(String[] args) {
		/* Arrays : 
		  ...
		  2) You can store just one data type in a Array
		  3) Array can store just primitive data types and reference of the objects
		...
		//Data Type[]        Name of the Array    =    new keyword          Data Type[length]
		     ...
		     //To print an array on the console use Array.toString(array name)
		    ...
		    // How to print an array element on the console
		     ...
		     //Find the sum of all element of the array arr
		     int sum = 0;
