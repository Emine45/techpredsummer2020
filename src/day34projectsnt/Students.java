...
public class Students {
    ...
    public static void removeStudent() {
        ...
        do {
            ...
            idOfStudent= scan.nextLine();
            result= studentInfo.remove(idOfStudent);//remove method with key returns the value in a map
            if(!idOfStudent.equals("X")) {
                System.out.println(result);
    ...
    public static void selectOptions() {
        ...
        System.out.println("2: Get the student information by Id");
        ...
        case 3:
            ...
            break;  
        default:
            System.out.println("Invalid selection, Select 1, 2, or 3");
        }
    }
}
