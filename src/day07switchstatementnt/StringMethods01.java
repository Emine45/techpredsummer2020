...
public class StringMethods01 {
	...
	public static void main(String[] args) {
		...
		// 7) equalsIgnoreCase() ==> To compare Strings without looking at to be upper or lower cases ==> Return boolean
		...
		//Do not put just '' in to the indexOf(), you get compile time error. You have to put a character
