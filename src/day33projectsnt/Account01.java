...
/*
  1)Ask user Customer Number, Pin Number
    If the credentials are invalid give a message to the user
  2)Select checking or saving account
  3)When you select any one of the accounts, you should see 
    a)Check balance
    b)Withdraw
    c)Deposit
    d)Exit
