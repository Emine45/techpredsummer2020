...
public class TypeCasting01 {
	...
	public static void main(String[] args) {
		...
		//1. Auto Widening Casting :If you convert small data type
		...
		int i3 = 432;
		float i4 = i3;
		System.out.println(i4);  //423.0
		
		//Explicit Narrowing Casting: If you want to concert large data type to
