...
public abstract class School {
	...
	//All access modifier can be used for variableabstract classes
	private int a = 12;
	int b = 13;
	protected int c = 14;
	public int d = 15;
	
	// It is optional to assign a value (initialize) for the variable
	private int e;
	int f;
	protected int g;
	public int h;
	
	// For abstract methods we can not use "private", "final" and "static" keywords but for variables we can.
