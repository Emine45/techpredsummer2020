...
public class Scope01 {
	 ...
	 //default values. Default value for numbers is 0 every time,for Strings it will be "", for char it will be ''.
	...
	public static void main(String[] args) {
		/*
		  ...
		  outside the method.
		  3. Rule : If you create a variable inside a method parentheses you can use
		            it just inside the method body. Do not use it outside the method 
		            body   
		  4. Rule :  If you want to use a variable, you have to declare first  
		  ...
		  NOTE : You have to assign a value for local variables but if you want you may not 
		         assign a value for Instance variables.
		 */
	...
	public void sub( ) {
		//Fallowing code is wrong because declaration must be done first
