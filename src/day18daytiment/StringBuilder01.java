...
public class StringBuilder01 {
	...
	public static void main(String[] args) {
		...
		/*
		   String are immutable, it means when you update a String Java creates
		   a new String object for the updated value. but it is not good to create
		   new object for every update, because of that Java created StringBuilder class.
		   StringBuilder class is mutable, it means it is open to update. Java does not 
		   need to create new objects for every update.
		...
		*/
		...
		//substring() method return String, because of that when you assign the return
