...
public class DateTime02 {
	...
	public static void main(String[] args) {
		...
		System.out.println(dtf3.format(time1));  //10:43
		
		System.out.println(dtf3.format(time1.plusHours(3)));   //01:45
		
		DateTimeFormatter dtf4 = DateTimeFormatter.ofPattern("HH:mm");
		System.out.println(dtf4.format(time1.plusHours(3)));  //13:48
		
		
		//How to get local time
		System.out.println(LocalTime.now(ZoneId.of("Turkey")));  //18:53:07.848
